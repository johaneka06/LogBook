        ...
        <div class="card-body">
          <form action="{{ url('/log/'.$log->id.'/update') }}" method="post" onload="onload()">
            ...
            <div class="row mb-3">
              ...
              <div class="me-auto col-7">
                <textarea name="detail" id="detail" placeholder="Place your detail activity" class="form-control" disabled>{{ $log->description }}</textarea>
              </div>
            </div>
            <div class="row mb-3">
            <div class="ms-auto col-3">
            ...
            <div class="me-auto col-7">
              <input type="time" name="clock_in" id="clock_in" placeholder="Clock in required" class="form-control" value="{{ $log->clock_in }}" disabled>
            </div>
          </div>
          <div class="row mb-3">
            <div class="ms-auto col-3">
            ...
            <div class="me-auto col-7">
              <input type="time" name="clock_out" id="clock_out" placeholder="Clock out can be null" class="form-control" value="{{ $log->clock_out }}" disabled>
            </div>
          </div>
